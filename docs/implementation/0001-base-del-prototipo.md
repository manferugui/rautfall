...
- esta especificación;
- `docs/implementation/0001-prototype-foundation.md` al finalizar la implementación;
- una actualización de `docs/project-status.md`.

Si `docs/project-status.md` ya existe, deberá actualizarse sin sobrescribir su contenido previo.
...
Al finalizar, crear `docs/implementation/0001-prototype-foundation.md` con:
...
Actualizar `docs/project-status.md` añadiendo:
